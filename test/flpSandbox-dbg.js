		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "zrealignreport",
									"targetURL": "#zrealignreportzrealignreport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zrealignreportzrealignreport-display": {
								"semanticObject": "zrealignreportzrealignreport",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zrealignreport.zrealignreport",
									"url": sap.ui.require.toUrl("zrealignreport/zrealignreport")
								}
							}
						}
					}
